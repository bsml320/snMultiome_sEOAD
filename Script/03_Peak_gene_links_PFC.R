...
write.csv(links_clean, file = "./Results/LINK/linkpeaks_all_PFC_1.23.csv",row.names = F)
...
pdf(file = "./Figures/LINK/Hist_link.peaks_PFC_1.23.pdf",width = 5,height = 5)
p1
dev.off()
...
linked_peaks <- read.csv("./Results/LINK/linkpeaks_all_PFC_1.23.csv",header = 1)
...
write.csv(linked_peaks_annotated, file = "./Results/LINK/PFC_linkpeaks_all_annotated_1.23.csv", row.names = F)