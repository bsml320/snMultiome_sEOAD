...
links<- read.csv("./Results/LINK/EC_linkpeaks_all_annotated_1.23.csv")
...
## saving results
write.csv(expr.res, file = "./Results/LINK/EC_enriched_JASPAR_motif_expr_1.23.csv")
## saving files
saveRDS(object, file = "cellbender_EC_object_10.31.rds")