...
links<- read.csv("./Results/LINK/PFC_linkpeaks_all_annotated_1.23.csv")
...
## saving results
write.csv(expr.res, file = "./Results/LINK/PFC_enriched_JASPAR_motif_expr_1.23.csv")
## saving files
saveRDS(object, file = "cellbender_PFC_object_10.31.rds")